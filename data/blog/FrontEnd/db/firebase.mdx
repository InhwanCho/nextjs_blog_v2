...
firebase db에는 다른 데이터 베이스처럼 collection과 document, field가 있습니다.
...
// 새로운 collection cities의 LA doc을 생성. doc이 없으면 생성되며, doc이 있으면 덮어씌웁니다.
// 세번째 옵션으로 { merge: true }를 준 경우는 예외입니다.
