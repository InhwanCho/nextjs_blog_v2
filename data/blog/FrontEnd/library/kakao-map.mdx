...
[1. \<Script>태그 이용하기, 2.useKakaoLoader 생성 및 활용하기]

개인적으로, app-router에서는 2.useKakaoLoader를 추천드립니다.
...
[react kakao map sdk](https://react-kakao-maps-sdk.jaeseokim.dev/docs 'nextjs kakao map sdk')
